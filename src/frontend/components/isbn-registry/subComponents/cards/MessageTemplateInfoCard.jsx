      ...
      <AccordionDetails>
        <div>
          ...
          <ul>
            ...
            <li>
              <span>#SUBTITLE#</span>
              <FormattedMessage id="messages.templates.form.instructions.subtitle" />
            </li>
            <li>
              <span>#IDENTIFIER#</span>
              <FormattedMessage id="messages.templates.form.instructions.identifier" />
            </li>
            <li>
              <span>#IDENTIFIERS#</span>
              <FormattedMessage id="messages.templates.form.instructions.identifiers" />
            </li>
            <li>
              <span>#EMAIL#</span>
              <FormattedMessage id="messages.templates.form.instructions.email" />
            </li>
            <li>
              <span>#PUBLISHER#</span>
              <FormattedMessage id="messages.templates.form.instructions.publisher" />
            </li>
            <li>
              <span>#ADDRESS#</span>
              <FormattedMessage id="messages.templates.form.instructions.address" />
            </li>
            <li>
              <span>#DATE#</span>
          ...
          <div className="instructionsText">
            ...
            <span>
              ...
              <Typography className="lineBreak">
                <FormattedMessage id="messages.templates.form.instructions.example.ids" />
                #IDENTIFIERS#
              </Typography>
              <Typography>
