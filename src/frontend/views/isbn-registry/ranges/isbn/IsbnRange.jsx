...
function IsbnRange() {
  ...
  const {
    ...
    url: `/api/isbn-registry/ranges/isbn/${id}`,
    method: 'GET',
    authenticationToken,
    dependencies: [id],
    prefetch: true,
  ...
  async function handleDeleteRange() {
    await makeApiRequest({
      url: `/api/isbn-registry/ranges/isbn/${range.id}`,
      method: 'DELETE',
      authenticationToken,
      setSnackbarMessage,
      history,
  ...
  async function handleOpenRange() {
    const result = await makeApiRequest({
      url: `/api/isbn-registry/ranges/isbn/${range.id}/open`,
      method: 'POST',
      authenticationToken,
      setSnackbarMessage
    });
  ...
  async function handleCloseRange() {
    const result = await makeApiRequest({
      url: `/api/isbn-registry/ranges/isbn/${range.id}/close`,
      method: 'POST',
      authenticationToken,
      setSnackbarMessage
    });
  ...
  async function handleActivateRange() {
    const result = await makeApiRequest({
      url: `/api/isbn-registry/ranges/isbn/${range.id}/activate`,
      method: 'POST',
      authenticationToken,
      setSnackbarMessage
    });
  ...
  async function handleDeactivateRange() {
    const result = await makeApiRequest({
      url: `/api/isbn-registry/ranges/isbn/${range.id}/deactivate`,
      method: 'POST',
      authenticationToken,
      setSnackbarMessage
    });
